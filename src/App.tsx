...
const monthNames = Array.from({ length: 12 }, (_, i) =>
  new Date(2000, i, 1).toLocaleDateString(navigator.language, {
    month: "long",
  }),
);

const iconButtonClassName =
  "flex items-center justify-center p-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-50 dark:focus:ring-offset-gray-900";
...
function CompoundInterestCalculator() {
  ...
  const positions = useMemo(() => {
    ...
    for (let i = 0; i < termInMonths; i++) {
      const date = addMonths(positions[i].date, 1);
      ...
      if (positions[i].date.getFullYear() === date.getFullYear()) {
      ...
      if (
        annualContribution > 0 &&
        date.getMonth() === annualContributionMonth
      ) {
        ...
        <Dialog.Root open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
          ...
          <Dialog.Portal>
            ...
            <Dialog.Content
              ...
              className="fixed top-0 right-0 h-dvh w-full max-w-xs bg-white dark:bg-gray-800 shadow-xl dark:shadow-gray-950/50 z-30 flex flex-col overflow-hidden focus:outline-none data-[state=open]:animate-[dialog-content-show_300ms_ease-out] data-[state=closed]:animate-[dialog-content-hide_300ms_ease-out]"
            >
              ...
              <div className="flex-1 min-h-0 overflow-y-auto divide-y divide-gray-200 dark:divide-gray-700">
                ...
                <div className="px-4 py-4 space-y-3">
                  ...
                  <SelectComponent
                    ...
                    onChange={setAnnualContributionMonth}
                    options={monthNames}
